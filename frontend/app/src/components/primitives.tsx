// CineAI — shared primitives (icons, phase data, helpers)
...
export const Icon: React.FC<IconProps> = ({ name, size = 16, stroke = 1.75 }) => {
  const s = size;
  const props = {
    width: s,
    height: s,
...
// Top nav used across all screens
interface TopNavProps {
  active?: string;
  onNav?: (id: string) => void;
}

export const TopNav: React.FC<TopNavProps> = ({ active, onNav }) => {
